...
public class QFeedEntity extends EntityPathBase<FeedEntity> {
    ...
    public final ListPath<FeedPicsEntity, QFeedPicsEntity> feedPicsEntities = this.<FeedPicsEntity, QFeedPicsEntity>createList("feedPicsEntities", FeedPicsEntity.class, QFeedPicsEntity.class, PathInits.DIRECT2);
