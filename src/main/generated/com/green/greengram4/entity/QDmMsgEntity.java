...
public class QDmMsgEntity extends EntityPathBase<DmMsgEntity> {
    ...
    public final QDmMsgIdentities dmMsgIdentities;
    ...
    public QDmMsgEntity(Class<? extends DmMsgEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.dmMsgIdentities = inits.isInitialized("dmMsgIdentities") ? new QDmMsgIdentities(forProperty("dmMsgIdentities")) : null;
